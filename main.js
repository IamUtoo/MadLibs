...
//Variables to display the madlib
const madLibDisplay = document.querySelector(".mad-lib");

//Variable for the form
const form = document.querySelector("form");

//Varaible for the madLib story
const story = 'My friend and I started a secret club. We meet every day by the <b>${adj1}</b><b>${noun1}</b>. Our club has some very special rules. If you want to join you have to wear a <b>${clothing}</b> on your <b>${bodyPart}</b>. You are not allowed to <b>${verb1}</b> during meetings, and you can only eat <b>${food}</b> for your meals. If you are interested in joining, let me know!'
